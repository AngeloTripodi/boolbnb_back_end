...
<div class="card px-5 py-3 mb-3">
    <div class="row">
        ...
        <div class="form-outline mb-3">
            <label for="description" class="form-label mb-1 @error('description') is-invalid @enderror">Description</label>
        ...
        <div class="form-outline w-100 pt-4 mb-3">
            <label for="image" class="form-label mb-1 @error('image') is-invalid @enderror">Select image:*</label>
