...
form.addEventListener('submit', (event) => {
    ...
    // Validazione letti
    if (bedsInput.value < 1 || bedsInput.value > 20) {
        bedsErrorMessage.innerHTML = `<i class="fa-solid fa-circle-exclamation pe-1"></i> Number of rooms must be between 1 and 20`;
    } else {
        bedsErrorMessage.innerHTML = '';
    }

    // Validazione bagni
    if (bathroomsInput.value < 1 || bathroomsInput.value > 20) {
        bathroomsErrorMessage.innerHTML = `<i class="fa-solid fa-circle-exclamation pe-1"></i> Number of beds must be between 1 and 30`;
    } else {
