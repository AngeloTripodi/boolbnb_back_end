...
Route::get('/user/sponsorships', [SponsorshipController::class, 'index'])->name('user.sponsorships.index');
Route::get('/user/sponsorships/checkout', [SponsorshipController::class, 'checkout'])->name('user.sponsorships.checkout');
